...
{
	if(flagTask1000ms == true)
	{
		flagTask1000ms = false;

		if(APP_BLE_Get_Server_Connection_Status() != APP_BLE_CONNECTED_SERVER)	tick1000ms++;
		else tick1000ms = 0;
		if(tick1000ms == 60)
		{
