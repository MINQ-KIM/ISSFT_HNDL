...
/* USER CODE BEGIN P2PC_APP_Init_1 */
  ...
  UTIL_SEQ_RegTask( 1<< CFG_TASK_SW1_PUSHED_ID, UTIL_SEQ_RFU, Button_Trigger_Received );

  P2P_Client_App_Context.Notification_Status = 1;
...
void P2PC_APP_SW1_Button_Action(void)
{
	UTIL_SEQ_SetTask(1<<CFG_TASK_SW1_PUSHED_ID, CFG_SCH_PRIO_0);
}
...
void SendCmd(void)
{
	  if(P2P_Client_APP_Get_State () != APP_BLE_CONNECTED_CLIENT)
	  {
		  APP_DBG_MSG("-- P2P APPLICATION CLIENT  : DON'T CONNECTED SERVER \n ");
		  APP_DBG_MSG(" \n\r");
	  }
	  else
	  {
		  if(P2P_Client_App_Context.Notification_Status){
		   APP_DBG_MSG("-- P2P APPLICATION SERVER  : INFORM CLIENT BUTTON 1 PUSHED \n ");
		   APP_DBG_MSG(" \n\r");
		   if(P2P_Client_App_Context.ButtonStatus.Button1 == 0x00)	P2P_Client_App_Context.ButtonStatus.Button1 = 0x01;
		   else P2P_Client_App_Context.ButtonStatus.Button1 = 0x00;
